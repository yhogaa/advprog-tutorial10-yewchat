    ...
    fn view(&self, ctx: &Context<Self>) -> Html {
        ...
        html! {
            <div class="flex w-screen bg-gray-800 text-white">
                <div class="flex-none w-56 h-screen bg-blue-600 text-white">
                    <div class="text-xl p-3">{"Users"}</div>
                    {
                        self.users.clone().iter().map(|u| {
                            html!{
                                <div class="flex m-3 bg-blue-600 rounded-lg p-2 text-white">
                                    <div>
                    ...
                    <div class="w-full grow overflow-auto border-b-2 border-gray-300">
                        {
                            self.messages.iter().map(|m| {
                                ...
                                html!{
                                    <div class="flex items-end w-3/6 bg-blue-600 m-8 rounded-tl-lg rounded-tr-lg rounded-br-lg text-white">
